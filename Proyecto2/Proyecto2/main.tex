...
\colorbox{red}{\#}\textcolor{green}{hola} \textcolor{red}{10} \textcolor{blue}{+} \textcolor{red}{3} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{adios} \textcolor{red}{5} \textcolor{blue}{+} \textcolor{green}{hola} \textcolor{blue}{+} \textcolor{red}{5} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{hi} \textcolor{red}{30} \textcolor{blue}{-} \textcolor{green}{adios} \textcolor{green}{bool} \textcolor{green}{holaFuncion} \textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 \textcolor{magenta}{int} \textcolor{green}{a} \textcolor{blue}{=} \textcolor{green}{hola} \textcolor{orange}{;} \\ 
 \textcolor{magenta}{int} \textcolor{green}{b} \textcolor{blue}{=} \textcolor{green}{hola} \textcolor{orange}{;} \\ 
 ...
 \textcolor{green}{printf} \textcolor{orange}{(} \textcolor{pink}{"Esto es una funciÃÿÿÿÿÿÿÿ³ÿÿÿÿÿÿÿn"} \textcolor{orange}{)} \textcolor{orange}{;} \\ 
 \textcolor{magenta}{return} \textcolor{red}{0} \textcolor{orange}{;} \\ 
 \end{frame}
\begin{frame}
\frametitle{C\'odigo Analizado}
\textcolor{orange}{\}} \\ 
 \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{x} \textcolor{red}{10} \textcolor{blue}{+} \textcolor{red}{20} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{a} \textcolor{red}{5} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{b} \textcolor{green}{a} \textcolor{blue}{+} \textcolor{red}{6} \textcolor{blue}{+} \textcolor{red}{3} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{a} \textcolor{red}{20} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{c} \textcolor{red}{30} \textcolor{blue}{+} \textcolor{green}{a} \textcolor{blue}{+} \textcolor{green}{b} \textcolor{blue}{+} \textcolor{red}{10} \colorbox{red}{\#}\textcolor{green}{define} \textcolor{green}{a} \textcolor{red}{40} \textcolor{blue}{+} \textcolor{green}{x} \textcolor{purple}{//"hola" } \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=96, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 15) (3 , 34) (4 , 4) (5 , 13) (6 , 22) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
