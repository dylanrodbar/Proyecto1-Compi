...
\textcolor{blue}{+} \textcolor{red}{3} \textcolor{red}{30} \textcolor{blue}{-} \textcolor{red}{5} \textcolor{blue}{+} \textcolor{red}{10} \textcolor{blue}{+} \textcolor{red}{3} \textcolor{green}{bool} \textcolor{green}{holaa} \textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=57, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 11) (3 , 10) (4 , 0) (5 , 9) (6 , 19) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
