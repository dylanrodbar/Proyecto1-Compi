...
\textcolor{orange}{\}} \\ 
 ...
 \textcolor{green}{printf} \textcolor{orange}{(} \textcolor{pink}{"Prueba"} \textcolor{orange}{)} \textcolor{orange}{;} \\ 
 \textcolor{magenta}{int} \textcolor{green}{t} \textcolor{blue}{=} \textcolor{red}{30} \textcolor{blue}{+} \textcolor{red}{40} \textcolor{blue}{+} \textcolor{red}{10} \textcolor{blue}{+} \textcolor{red}{20} \textcolor{blue}{+} \textcolor{red}{40} \textcolor{blue}{+} \textcolor{red}{10} \textcolor{blue}{+} \textcolor{red}{20} \textcolor{blue}{+} \textcolor{red}{6} \textcolor{blue}{+} \textcolor{red}{3} \textcolor{blue}{+} \textcolor{red}{10} \textcolor{orange}{;} \\ 
 \textcolor{orange}{\}} \\ 
 \textcolor{white}{} \end{frame}
\begin{frame}
\frametitle{Histograma}
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=76, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 7) (2 , 15) (3 , 11) (4 , 0) (5 , 14) (6 , 26) (7 , 3)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
