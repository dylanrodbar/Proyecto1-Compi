...
\textcolor{orange}{\}} \\ 
 ...
 \textcolor{purple}{//adios oidhofhofaushoi @@ \& \textbackslash n \$ int 2funcionPruebaSegunda()\{} \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=47, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 5) (2 , 5) (3 , 8) (4 , 4) (5 , 4) (6 , 19) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
