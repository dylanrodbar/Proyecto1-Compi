...
\textcolor{purple}{//adios oidhofhofaushoi @@ \textbackslash \#\textbackslash \#} \\ 
 \textcolor{magenta}{int} \textcolor{green}{funcionPruebaSegunda} \textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 \textcolor{purple}{/*  printf("Prueba")\;
  int t = c\;
  t++\;
*/} \\ 
 \textcolor{orange}{\}} \\ 
 \textcolor{magenta}{int} \textcolor{green}{laNota} \textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 \textcolor{magenta}{if} \textcolor{orange}{(} \textcolor{green}{j} \textcolor{blue}{=} \textcolor{blue}{=} \textcolor{red}{90} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 \textcolor{green}{printf} \textcolor{orange}{(} \textcolor{pink}{"\#\#\# no nos puede ir mal \#\#\#\textbackslash n"} \textcolor{orange}{)} \textcolor{orange}{;} \\ 
 \textcolor{green}{yuya} \textcolor{blue}{=} \textcolor{pink}{"no"} \textcolor{orange}{;} \\ 
 \textcolor{orange}{\}} \\ 
 \end{frame}
\begin{frame}
\frametitle{C\'odigo Analizado}
\textcolor{magenta}{else} \textcolor{orange}{\{} \\ 
 \textcolor{orange}{\}} \\ 
 \textcolor{orange}{\}} \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=36, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 4) (2 , 1) (3 , 5) (4 , 3) (5 , 3) (6 , 18) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
