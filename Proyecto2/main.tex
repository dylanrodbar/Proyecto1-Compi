...
\begin{frame}
\frametitle{C\'odigo Analizado}
\textcolor{pink}{""} \colorbox{red}{"}\textcolor{magenta}{int} \textcolor{green}{numero} \textcolor{blue}{=} \textcolor{red}{5} \textcolor{orange}{;} \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=50, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 7) (3 , 9) (4 , 0) (5 , 6) (6 , 19) (7 , 3)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
