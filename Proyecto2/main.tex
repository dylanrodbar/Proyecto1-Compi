...
\textcolor{red}{50} \textcolor{green}{bool} \textcolor{green}{hola} \textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 ...
 \textcolor{magenta}{int} \textcolor{green}{h} \textcolor{blue}{=} \textcolor{red}{20} \textcolor{orange}{;} \\ 
 \textcolor{white}{} \end{frame}
\begin{frame}
\frametitle{Histograma}
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=45, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 5) (3 , 10) (4 , 0) (5 , 3) (6 , 19) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
...
\def\angle{0}
\def\radius{3}
\def\cyclelist{{"yellow","blue","red","green","orange","purple"}}
