...
\textcolor{orange}{\}} \\ 
 ...
 \textcolor{purple}{//adios oidhofhofaushoi @@ \#\#} \\ 
...
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=56, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 5) (3 , 10) (4 , 3) (5 , 4) (6 , 25) (7 , 3)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
