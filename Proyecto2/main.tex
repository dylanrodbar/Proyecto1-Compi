...
\textcolor{purple}{//"hola" } \\ 
 \textcolor{purple}{//adios oidhofhofaushoi Ãÿÿÿÿÿÿÿ±ÿÿÿÿÿÿÿÃÿÿÿÿÿÿÿ±ÿÿÿÿÿÿÿ @@ \& \textbackslash n \$ \# } \\ 
 \textcolor{purple}{/*\#*/} \\ 
 \colorbox{red}{\$}\colorbox{red}{\#}\colorbox{red}{Ã}\colorbox{red}{±}\textcolor{magenta}{int} \colorbox{red}{2funcionPruebaSegunda}\textcolor{orange}{(} \textcolor{orange}{)} \textcolor{orange}{\{} \\ 
 \textcolor{purple}{/*printf("Prueba\#\&\textbackslash n")\;
	int t = c\;\#
	t++\;*/} \\ 
 \textcolor{purple}{//\#} \\ 
 \colorbox{red}{\#}\textcolor{orange}{\}} \\ 
 \colorbox{red}{\#}\textcolor{white}{} \end{frame}
\begin{frame}
\frametitle{Histograma}
\begin{tikzpicture}
\begin{axis}[ybar interval, ymax=51, ymin=0, minor y tick num = 3]
\addplot coordinates { (1 , 6) (2 , 5) (3 , 8) (4 , 5) (5 , 4) (6 , 21) (7 , 2)  (8, 0) }; 
\end{axis}
\end{tikzpicture}
\end{frame}
\begin{frame}
